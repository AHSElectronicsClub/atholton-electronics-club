...
<svg {...props} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" strokeWidth="0.5" stroke="rgba(255,255,255,0.5)">
...
// Default wrapper for backward compatibility (optional)
const Icons = ({ name, ...props }: { name: string } & React.SVGProps<SVGSVGElement>) => {
switch (name) {
case 'users': return <UsersIcon {...props} />;
case 'layers': return <LayersIcon {...props} />;
case 'book': return <BookOpenIcon {...props} />;
case 'rss': return <RssIcon {...props} />;
