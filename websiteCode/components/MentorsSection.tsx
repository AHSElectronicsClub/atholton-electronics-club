...
export default function MentorsSection() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h2 className="text-3xl font-bold font-display text-forest mb-8">Our Mentors</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
        {MENTORS_DATA.map(mentor => (
          <div key={mentor.id} className="bg-off-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:shadow-2xl transition-shadow">
            <img
              src={mentor.imageUrl}
              alt={mentor.name}
